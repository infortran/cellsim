                ...
                <div class="col-lg-7 mb-md-3 mb-lg-0">
                    <div class="row align-items-center">
                        <div class="col-auto flex-horizontal-center">
                            ...
                            <h2 class="font-size-20 mb-0 ml-3">Suscríbete a nuestro Newsletter</h2>
                        </div>
                        <div class="col my-4 my-md-0">
                            <h5 class="font-size-15 ml-4 mb-0">...y recibe <strong>las ofertas en tu correo.</strong></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="row">
                        ...
                        <div class="col-12 col-md mb-4 mb-md-0">
                            <h6 class="mb-3 font-weight-bold">Busca por marca</h6>
                            <!-- List Group -->
                        ...
                        <!--div class="col-12 col-md mb-4 mb-md-0">
                            <h6 class="mb-3 font-weight-bold">Atención al cliente</h6>
                            <!-- List Group -->
                            <!--ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
                                <li><a class="list-group-item list-group-item-action" href="../shop/my-account.html">Mi cuenta</a></li>
                                <li><a class="list-group-item list-group-item-action" href="../shop/track-your-order.html">Terminos y condiciones</a></li>
    ...
    <div class="bg-gray-14 py-2">
        <div class="container">
            <div class="flex-center-between d-block d-md-flex">
                <div class="mb-3 mb-md-0">© <a href="https://infortran.cl/" class="font-weight-bold text-gray-90">Infortran S.I.</a> - Todos los derechos reservados.</div>
