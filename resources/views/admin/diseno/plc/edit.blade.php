                                    ...
                                    <div class="col-md-3 col-lg-4">
                                        <div class="banner-col-productos">
                                            <div class="banner-lateral-container">
                                                <img id="img-input-producto" src="{{asset('uploads/plc/300X616/'.$plc->img)}}" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="categoria_id" class="form-control selectpicker" data-style="btn btn-link" id="">
                                                        ...
                                                        @foreach($categorias as $categoria)
                                                            <option value="{{$categoria->id}}" {{$categoria->id === $plc->categoria->id ? 'selected':''}}>{{$categoria->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
